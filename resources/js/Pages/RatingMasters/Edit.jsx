...
const Edit = ({ ratingMaster: initialRating }) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        Inertia.put(`/rating-masters/${rating.id}`, rating);
    };

    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">評価マスター編集</h2>}
        >
            <Head title="評価マスター編集" />
