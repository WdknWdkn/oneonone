...
const Index = ({ userDepartments }) => {
    const { auth } = usePage().props;

    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">部署一覧</h2>}
        >
            <Head title="部署一覧" />
                        ...
                        <table className="min-w-full divide-y divide-gray-200">
                            <thead className="bg-gray-50">
                                <tr>
                                    ...
                                    <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">部署名</th>
                                ...
                                {userDepartments.map(department => (
                                    <tr key={department.id}>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <InertiaLink
                                                href={`/user-departments/${department.id}/edit`}
                                            ...
                                            <form action={`/user-departments/${department.id}`} method="POST" className="inline">
